...
- **Production site live** at https://ciclomapa.org.br (TWA loads the real site)
...
- **Start URL**: `https://ciclomapa.org.br/`
- **Icon URL**: `https://ciclomapa.org.br/icon-512.png`
- **Maskable Icon URL**: `https://ciclomapa.org.br/icon-maskable-512.png`
- **Theme Color**: `#1c1717`
...
2. **Create** `public/.well-known/assetlinks.json` (copy from `assetlinks.json.template`):
   ...
   - This will be served at `https://ciclomapa.org.br/.well-known/assetlinks.json`.
...
4. **Verify** at: https://digitalassetlinks.googleapis.com/v1/statements:list?source.web.site=https://ciclomapa.org.br&relation=delegate_permission/common.handle_all_urls
...
6. **Privacy policy**
   - Required. Host at e.g. `https://ciclomapa.org.br/privacidade` or similar.
...
- Confirm the app opens https://ciclomapa.org.br in fullscreen.
...
| `public/icon-maskable-192.png` | New — Maskable icon |
