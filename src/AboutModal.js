      ...
      <div className="relative max-w-lg p-4 sm:p-0">
        <div className="mt-12">
          ...
          <div className="mb-8 text-sm md:text-lg">
            <p>
              O CicloMapa é uma plataforma colaborativa gratuita que mostra onde existem (e onde
              faltam) ciclovias, ciclofaixas, ciclorrotas e outros equipamentos para bicicletas nas
              cidades brasileiras.
            </p>
            ...
            <p>
              ...
              (a Wikipedia dos mapas) ela permite que cidadãos, pesquisadores e gestores públicos
              visualizem, baixem e usem essas informações para melhorar a mobilidade por bicicleta
              no Brasil.
            </p>
          </div>
            ...
            <div className="flex h-10 mt-6 mb-6 gap-4 justify-between">
              ...
              >
                <img
                  ...
                  alt="Logo do premiobicicletabrasil"
                />
              </a>
              <a
                className="h-full b-and-w"
